...
[NumPy](http://www.numpy.org) is the fundamental package for scientific computing with Python. Most of the other SL packages are based on it.

### Installation

If can be installed using `pip` or `Anaconda`:
```
$ pip install numpy
```
or
...
This cheat sheet can also act as an introduction to Python for data science.
...
This is a growing list of examples. Know a good trick? Let me know (funmayank at yahoo<dot>co<dot>in) or fork it and create a pull request.
...
- [Original Document](https://github.com/juliangaal/python-cheat-sheet/tree/master/NumPy)